...
class PrisonVisitBookingJsonApiController extends ControllerBase {
  ...
  public function renderApi() {
    ...
    if ($this->isValidRequest() === FALSE) {
      ...
      $response->setData(['status' => 'error', 'message' => 'Unauthorised request'])->setStatusCode(401);
      return $response;
    }
    else {
      ...
      if ($data) {
        ...
        $response->setData(['status' => 'success', 'message' => 'Data received'])->setStatusCode(200);
      }
      else {
        // Return "400 Bad Request" response.
        $response->setData(['status' => 'error', 'message' => 'Bad request'])->setStatusCode(400);
      }
    }
